...
@section('content')
    ...
    @foreach($product_category as $v_product)
    <div class="col-sm-4">
        <div class="product-image-wrapper">
            <div class="single-products">
                <div class="productinfo text-center">
                    <img src="{{URL::to($v_product->product_image)}}" style=" height: 100px" />
            ...
            <div class="choose">
                <ul class="nav nav-pills nav-justified">
                    ...
                    <li><a href="{{URL::to('/product_details/'. $v_product->product_id)}}"><i class="fa fa-plus-square"></i>View Details</a></li>
                </ul>
            </div>
        </div>
    </div>
